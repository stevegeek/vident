...
module Vident
  module PublicApiSpec
    # Runs the adapter-agnostic spec modules against Vident2::Phlex::HTML.
    # Phase 2 starts with this class observing massive red — Vident2 is
    # an empty stub. Features land progressively (tasks 21-25); this
    # suite going green is the acceptance gate for 2.0.
    class PhlexV2Test < Minitest::Test
      include PhlexV2Adapter
      include CoreDSL
      include Mutators
      include Controllers
