...
module Dashboard
  class ToastComponent < ApplicationComponent
    ...
    stimulus do
      ...
      actions -> { [ReleaseCardComponent.stimulus_scoped_event_on_window(:promoted), :handle_promoted] },
        -> { [ReleaseCardComponent.stimulus_scoped_event_on_window(:cancelled), :handle_cancelled] },
        :dismiss
    end
