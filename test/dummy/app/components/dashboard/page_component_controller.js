...
// Host for release-card outlets. Cards self-register via `stimulus_outlet_host:`
...
export default class extends Controller {
  ...
  // `dashboardReleaseCardComponentOutletConnected` — Stimulus connects the card
  ...
  #applyFilter(query) {
    ...
    for (const card of this.dashboardReleaseCardComponentOutlets) {
      ...
      const matchesQuery = q === "" || card.nameValue.toLowerCase().includes(q)
