...
module Vident2
  class ValueClassesTest < Minitest::Test
    def setup
      @implied = Vident2::Stimulus::Controller.new(
    ...
    def test_naming_stimulize_path_dasherizes_and_joins_with_double_dash
      assert_equal "admin--user-card", Vident2::Stimulus::Naming.stimulize_path("admin/user_card")
    end

    def test_naming_stimulize_path_accepts_symbol
      assert_equal "foo--bar", Vident2::Stimulus::Naming.stimulize_path(:"foo/bar")
    end

    def test_naming_js_name_lower_camel_cases
      assert_equal "myThing", Vident2::Stimulus::Naming.js_name(:my_thing)
      assert_equal "handleClick", Vident2::Stimulus::Naming.js_name("handle_click")
    end

    # ---- Null ----------------------------------------------------------

    def test_null_sentinel_serialises_to_literal_null_string
      assert_equal "null", Vident2::Stimulus::Null.to_s
    end

    def test_null_sentinel_inspect
      assert_equal "Vident2::Stimulus::Null", Vident2::Stimulus::Null.inspect
    end

    def test_null_sentinel_is_frozen
      assert_predicate Vident2::Stimulus::Null, :frozen?
    end

    # ---- Controller.parse ---------------------------------------------

    def test_controller_parse_no_args_clones_implied
      c = Vident2::Stimulus::Controller.parse(implied: @implied)
    ...
    def test_controller_parse_with_path_string_stimulizes
      c = Vident2::Stimulus::Controller.parse("admin/users", implied: @implied)
      assert_equal "admin/users", c.path
      assert_equal "admin--users", c.name
    end

    def test_controller_parse_carries_alias_name
      c = Vident2::Stimulus::Controller.parse("admin/users", as: :admin, implied: @implied)
    ...
    def test_controller_to_data_hash_space_joins
      a = Vident2::Stimulus::Controller.parse(implied: @implied)
      b = Vident2::Stimulus::Controller.parse("admin/users", implied: @implied)
      assert_equal({controller: "foo--my-controller admin--users"},
        Vident2::Stimulus::Controller.to_data_hash([a, b]))
    end

    def test_controller_to_data_hash_empty
      assert_equal({}, Vident2::Stimulus::Controller.to_data_hash([]))
    end

    # ---- Action.parse -------------------------------------------------

    def test_action_parse_single_symbol_is_implied_method_no_event
      a = Vident2::Stimulus::Action.parse(:click, implied: @implied)
      assert_nil a.event
    ...
    def test_action_parse_symbol_symbol_is_event_method
      a = Vident2::Stimulus::Action.parse(:click, :handle_click, implied: @implied)
    ...
    def test_action_parse_string_symbol_is_controller_path_method
      a = Vident2::Stimulus::Action.parse("admin/users", :show, implied: @implied)
      assert_nil a.event
    ...
    def test_action_parse_three_args_event_controller_method
      a = Vident2::Stimulus::Action.parse(:hover, "path/to/ctrl", :go, implied: @implied)
    ...
    def test_action_parse_qualified_string_passthrough
      a = Vident2::Stimulus::Action.parse("click->admin/users#show", implied: @implied)
      assert_equal "click", a.event
      assert_equal "admin/users", a.controller.name
    ...
    def test_action_parse_hash_descriptor
      a = Vident2::Stimulus::Action.parse(
    ...
    def test_action_parse_hash_invalid_option_raises
      assert_raises(::Vident2::ParseError) do
        Vident2::Stimulus::Action.parse(
    ...
    def test_action_parse_invalid_argument_shape_raises
      assert_raises(::Vident2::ParseError) do
        Vident2::Stimulus::Action.parse(123, implied: @implied)
      end
    end
    ...
    def test_action_to_data_hash_space_joined_under_single_action_key
      a = Vident2::Stimulus::Action.parse(:click, implied: @implied)
      b = Vident2::Stimulus::Action.parse(:submit, :handle, implied: @implied)
      assert_equal(
        {action: "foo--my-controller#click submit->foo--my-controller#handle"},
        Vident2::Stimulus::Action.to_data_hash([a, b])
      )
    end

    def test_action_to_data_hash_empty
      assert_equal({}, Vident2::Stimulus::Action.to_data_hash([]))
    end

    # ---- Target.parse -------------------------------------------------

    def test_target_parse_single_symbol_on_implied
      t = Vident2::Stimulus::Target.parse(:input, implied: @implied)
    ...
    def test_target_parse_camelizes_snake_case_symbol
      t = Vident2::Stimulus::Target.parse(:submit_button, implied: @implied)
      assert_equal "submitButton", t.name
    end

    def test_target_parse_string_symbol_cross_controller
      t = Vident2::Stimulus::Target.parse("admin/users", :row, implied: @implied)
    ...
    def test_target_to_data_hash_same_controller_same_key_concatenates
      a = Vident2::Stimulus::Target.parse(:input, implied: @implied)
      b = Vident2::Stimulus::Target.parse(:output, implied: @implied)
      assert_equal(
        {:"foo--my-controller-target" => "input output"},
        Vident2::Stimulus::Target.to_data_hash([a, b])
      )
    end

    def test_target_to_data_hash_different_controller_different_key
      a = Vident2::Stimulus::Target.parse(:input, implied: @implied)
      b = Vident2::Stimulus::Target.parse("admin/users", :row, implied: @implied)
      result = Vident2::Stimulus::Target.to_data_hash([a, b])
    ...
    def test_value_parse_two_args_uses_implied_controller
      v = Vident2::Stimulus::Value.parse(:url, "https://example.com", implied: @implied)
    ...
    def test_param_parse_two_args_uses_implied_controller
      p = Vident2::Stimulus::Param.parse(:item_id, 42, implied: @implied)
    ...
    def test_param_to_data_hash
      a = Vident2::Stimulus::Param.parse(:item_id, 42, implied: @implied)
      b = Vident2::Stimulus::Param.parse(:role, "admin", implied: @implied)
      assert_equal(
        {
          :"foo--my-controller-item-id-param" => "42",
          :"foo--my-controller-role-param" => "admin"
        },
        Vident2::Stimulus::Param.to_data_hash([a, b])
      )
    end

    def test_param_parse_false_serializes_to_string
      p = Vident2::Stimulus::Param.parse(:flag, false, implied: @implied)
    ...
    def test_class_map_parse_with_string_css
      m = Vident2::Stimulus::ClassMap.parse(:loading, "opacity-50 cursor-wait", implied: @implied)
    ...
    def test_class_map_parse_with_array_css
      m = Vident2::Stimulus::ClassMap.parse(:loading, %w[opacity-50 cursor-wait], implied: @implied)
      assert_equal "opacity-50 cursor-wait", m.css
    end
    ...
    def test_class_map_parse_with_cross_controller
      m = Vident2::Stimulus::ClassMap.parse("admin/users", :active, "bg-blue", implied: @implied)
    ...
    def test_class_map_parse_invalid_css_type_raises
      assert_raises(::Vident2::ParseError) do
        Vident2::Stimulus::ClassMap.parse(:loading, 42, implied: @implied)
      end
    end

    def test_class_map_to_data_pair
      m = Vident2::Stimulus::ClassMap.parse(:loading, "p-4", implied: @implied)
      assert_equal [:"foo--my-controller-loading-class", "p-4"], m.to_data_pair
    end

    def test_class_map_to_data_hash
      a = Vident2::Stimulus::ClassMap.parse(:loading, "op-50", implied: @implied)
      b = Vident2::Stimulus::ClassMap.parse(:active, "bg-blue", implied: @implied)
      assert_equal(
        {
          :"foo--my-controller-loading-class" => "op-50",
          :"foo--my-controller-active-class" => "bg-blue"
        },
        Vident2::Stimulus::ClassMap.to_data_hash([a, b])
      )
    end
    ...
    def test_outlet_parse_single_symbol_auto_selector_with_component_id
      o = Vident2::Stimulus::Outlet.parse(:menu, implied: @implied, component_id: "host-1")
    ...
    def test_outlet_parse_single_symbol_auto_selector_no_component_id
      o = Vident2::Stimulus::Outlet.parse(:menu, implied: @implied)
      assert_equal "[data-controller~=menu]", o.selector
    end

    def test_outlet_parse_array_pair_explicit_selector
      o = Vident2::Stimulus::Outlet.parse([:menu, ".js-menu"], implied: @implied)
      assert_equal "menu", o.name
    ...
    def test_outlet_parse_three_args_ctrl_name_selector
      o = Vident2::Stimulus::Outlet.parse("admin/users", :menu, ".x", implied: @implied)
    ...
    def test_outlet_parse_component_with_stimulus_identifier
      ...
      o = Vident2::Stimulus::Outlet.parse(component, implied: @implied, component_id: "h")
    ...
    def test_registry_kinds_are_all_seven
      assert_equal(
        ...
        Vident2::Internals::Registry::KINDS.map(&:name)
      )
    end

    def test_registry_fetch_returns_kind_record
      k = Vident2::Internals::Registry.fetch(:actions)
      assert_equal :actions, k.name
      assert_equal Vident2::Stimulus::Action, k.value_class
      refute k.keyed
    end

    def test_registry_class_maps_has_plural_classes
      k = Vident2::Internals::Registry.fetch(:class_maps)
      assert_equal :classes, k.plural_name
      assert_equal Vident2::Stimulus::ClassMap, k.value_class
      assert k.keyed
    end

    def test_registry_fetch_unknown_raises
      assert_raises(KeyError) { Vident2::Internals::Registry.fetch(:bogus) }
    end

    def test_registry_each_yields_kind_records
      names = []
      Vident2::Internals::Registry.each { |k| names << k.name }
    ...
    def test_all_kinds_to_data_hash_returns_symbol_keys
      ctrl = Vident2::Stimulus::Controller.parse("foo", implied: @implied)
      act = Vident2::Stimulus::Action.parse(:click, implied: @implied)
      tgt = Vident2::Stimulus::Target.parse(:x, implied: @implied)
      val = Vident2::Stimulus::Value.parse(:n, 1, implied: @implied)
      prm = Vident2::Stimulus::Param.parse(:n, 1, implied: @implied)
      cm = Vident2::Stimulus::ClassMap.parse(:n, "a", implied: @implied)
      out = Vident2::Stimulus::Outlet.parse(:n, ".x", implied: @implied)

      [
        Vident2::Stimulus::Controller.to_data_hash([ctrl]),
        Vident2::Stimulus::Action.to_data_hash([act]),
        Vident2::Stimulus::Target.to_data_hash([tgt]),
        Vident2::Stimulus::Value.to_data_hash([val]),
        Vident2::Stimulus::Param.to_data_hash([prm]),
        Vident2::Stimulus::ClassMap.to_data_hash([cm]),
        Vident2::Stimulus::Outlet.to_data_hash([out])
      ].each do |hash|
    ...
    def test_target_parse_from_string
      t = Vident2::Stimulus::Target.parse("my-button", implied: @implied)
      assert_equal "my-button", t.name
      assert_equal @implied, t.controller
    end

    def test_target_parse_invalid_shape_raises
      assert_raises(::Vident2::ParseError) { Vident2::Stimulus::Target.parse(42, implied: @implied) }
    end

    def test_controller_parse_too_many_args_raises
      assert_raises(::Vident2::ParseError) do
        Vident2::Stimulus::Controller.parse("a", "b", implied: @implied)
      end
    end

    def test_value_parse_invalid_shape_raises
      assert_raises(::Vident2::ParseError) { Vident2::Stimulus::Value.parse(:foo, implied: @implied) }
    end

    def test_param_parse_invalid_shape_raises
      assert_raises(::Vident2::ParseError) { Vident2::Stimulus::Param.parse(:foo, implied: @implied) }
    end

    def test_class_map_parse_invalid_shape_raises
      assert_raises(::Vident2::ParseError) { Vident2::Stimulus::ClassMap.parse(:foo, implied: @implied) }
    end

    def test_outlet_parse_from_string_uses_auto_selector
      o = Vident2::Stimulus::Outlet.parse("my-outlet", implied: @implied, component_id: "h")
    ...
    def test_outlet_parse_invalid_shape_raises
      assert_raises(::Vident2::ParseError) { Vident2::Stimulus::Outlet.parse(42, implied: @implied) }
    end
    ...
    def test_collection_merge_same_kind
      kind = Vident2::Internals::Registry.fetch(:targets)
      t1 = Vident2::Stimulus::Target.parse(:a, implied: @implied)
      t2 = Vident2::Stimulus::Target.parse(:b, implied: @implied)
      c1 = Vident2::Stimulus::Collection.new(kind: kind, items: [t1])
      c2 = Vident2::Stimulus::Collection.new(kind: kind, items: [t2])
      merged = c1.merge(c2)
    ...
    def test_collection_merge_different_kind_raises
      target_kind = Vident2::Internals::Registry.fetch(:targets)
      action_kind = Vident2::Internals::Registry.fetch(:actions)
      c1 = Vident2::Stimulus::Collection.new(kind: target_kind, items: [])
      c2 = Vident2::Stimulus::Collection.new(kind: action_kind, items: [])
    ...
    def test_collection_supports_hash_splat
      kind = Vident2::Internals::Registry.fetch(:targets)
      items = [Vident2::Stimulus::Target.parse(:a, implied: @implied),
               Vident2::Stimulus::Target.parse(:b, implied: @implied)]
      collection = Vident2::Stimulus::Collection.new(kind: kind, items: items)
