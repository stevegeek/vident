...
module Vident2
  ...
  class ResolverTest < Minitest::Test
    ...
    def test_implied_controller_seeded_by_default
      cls = make_component
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new)
    ...
    def test_controllers_prop_appends_to_implied
      ...
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, instance)
    ...
    def test_action_proc_resolves_in_instance_binding
      ...
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new(mode: :submit))
    ...
    def test_outlet_proc_resolved_in_instance_binding
      ...
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new(selector: ".custom"))
    ...
    def test_class_map_proc_resolved
      ...
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new(status: :error))
    ...
    def test_result_is_a_draft_not_a_plan
      cls = make_component
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new)
      assert_kind_of ::Vident2::Internals::Draft, draft
      refute draft.sealed?
    end
    ...
    def test_result_draft_accepts_further_mutations
      ...
      draft = ::Vident2::Internals::Resolver.call(cls.declarations, cls.new)
      assert_equal 1, draft.controllers.size
      action = ::Vident2::Stimulus::Action.parse(
        :click,
    ...
    def test_prop_accepts_pre_built_value_object
      cls = make_component
      implied = ::Vident2::Stimulus::Controller.new(path: "button_component", name: "button-component")
      preset = ::Vident2::Stimulus::Action.parse(:click, implied: implied)
