...
module Vident2
  class DSLTest < Minitest::Test
    ...
    def test_fresh_component_has_empty_declarations
      cls = make_component
      assert_equal ::Vident2::Internals::Declarations.empty, cls.declarations
    end
    ...
    def test_empty_declarations_all_fields_empty
      d = ::Vident2::Internals::Declarations.empty
    ...
    def test_declarations_fields_are_frozen_arrays
      cls = make_component { stimulus { action :click; value :x, static: 1 } }
    ...
    def test_no_stimulus_controller_with_action_raises_declaration_error
      assert_raises(::Vident2::DeclarationError) do
        make_component do
    ...
    def test_declaration_error_message_names_the_class
      err = assert_raises(::Vident2::DeclarationError) do
        make_component do
          no_stimulus_controller
          stimulus { action :click }
        end
    ...
    def test_declaration_error_inherits_vident2_error
      assert_operator ::Vident2::DeclarationError, :<, ::Vident2::Error
    end

    def test_parse_error_inherits_declaration_error
      assert_operator ::Vident2::ParseError, :<, ::Vident2::DeclarationError
    end

    def test_all_error_classes_exist
      [
        ::Vident2::Error,
        ::Vident2::DeclarationError,
        ::Vident2::ParseError,
        ::Vident2::RenderError,
        ::Vident2::StateError,
        ::Vident2::ConfigurationError
    ...
    def test_declarations_empty_singleton
      assert_same ::Vident2::Internals::Declarations.empty,
        ::Vident2::Internals::Declarations.empty
    end

    def test_declarations_merge_concatenates_positional
      a = ::Vident2::Internals::Declarations.empty
      b = ::Vident2::Internals::Declarations.new(
        controllers: [].freeze,
        actions: [::Vident2::Internals::Declaration.of(:x)].freeze,
        targets: [].freeze,
        outlets: [].freeze,
        values: [].freeze,
        params: [].freeze,
    ...
    def test_declarations_merge_last_write_wins_keyed
      d1 = ::Vident2::Internals::Declaration.of("v1")
      d2 = ::Vident2::Internals::Declaration.of("v2")
      a = ::Vident2::Internals::Declarations.new(
    ...
    def test_action_and_target_return_fluent_builders
      dsl = ::Vident2::Internals::DSL.new
      assert_kind_of ::Vident2::Internals::ActionBuilder, dsl.action(:click)
      assert_kind_of ::Vident2::Internals::TargetBuilder, dsl.target(:x)
    end
    ...
    def test_action_method_override
      dsl = ::Vident2::Internals::DSL.new
      dsl.action(:submit).on(:form).method(:handle_submit)
      descriptor = dsl.to_declarations.actions.first.args.first
    ...
    def test_declaration_of_freezes_args
      d = ::Vident2::Internals::Declaration.of(:a, :b)
      assert_predicate d.args, :frozen?
    end

    def test_declaration_captures_when_proc_meta
      fn = -> { true }
      d = ::Vident2::Internals::Declaration.of(:x, when_proc: fn, static: 1)
