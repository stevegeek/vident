...
module Vident2
  ...
  class AttributeWriterTest < Minitest::Test
    ...
    def plan_with(**collections)
      empty = ::Vident2::Internals::Registry.names.to_h { |n| [n, [].freeze] }
      ::Vident2::Internals::Plan.new(**empty.merge(collections))
    end

    # ---- Empty plan -----------------------------------------------------

    def test_empty_plan_returns_empty_hash
      assert_equal({}, ::Vident2::Internals::AttributeWriter.call(plan_with))
    end

    # ---- Controllers ----------------------------------------------------

    def test_controllers_space_joined_under_controller_key
      c2 = ::Vident2::Stimulus::Controller.new(path: "tooltip", name: "tooltip")
      plan = plan_with(controllers: [@controller, c2])
      assert_equal({controller: "button-component tooltip"},
        ::Vident2::Internals::AttributeWriter.call(plan))
    end
    ...
    def test_actions_space_joined_under_action_key
      a1 = ::Vident2::Stimulus::Action.parse(:click, implied: @controller)
      a2 = ::Vident2::Stimulus::Action.parse(:submit, implied: @controller)
    ...
    def test_targets_grouped_by_controller
      t1 = ::Vident2::Stimulus::Target.parse(:input, implied: @controller)
      t2 = ::Vident2::Stimulus::Target.parse(:output, implied: @controller)
      plan = plan_with(targets: [t1, t2])
      hash = ::Vident2::Internals::AttributeWriter.call(plan)
      assert_equal({:"button-component-target" => "input output"}, hash)
    end

    def test_targets_across_controllers_get_separate_keys
      c2 = ::Vident2::Stimulus::Controller.new(path: "admin", name: "admin")
      t1 = ::Vident2::Stimulus::Target.parse(:input, implied: @controller)
      t2 = ::Vident2::Stimulus::Target.parse(:row, implied: c2)
      plan = plan_with(targets: [t1, t2])
      hash = ::Vident2::Internals::AttributeWriter.call(plan)
    ...
    def test_values_emit_one_key_per_entry
      v1 = ::Vident2::Stimulus::Value.parse(:title, "Hi", implied: @controller)
      v2 = ::Vident2::Stimulus::Value.parse(:count, 7, implied: @controller)
    ...
    def test_params_emit_one_key_per_entry
      p1 = ::Vident2::Stimulus::Param.parse(:kind, "promote", implied: @controller)
    ...
    def test_class_maps_emit_one_key_per_entry
      cm = ::Vident2::Stimulus::ClassMap.parse(:loading, "opacity-50", implied: @controller)
    ...
    def test_outlets_emit_one_key_per_entry
      o = ::Vident2::Stimulus::Outlet.parse(:modal, ".modal", implied: @controller)
    ...
    def test_all_kinds_together_in_one_call
      a = ::Vident2::Stimulus::Action.parse(:click, implied: @controller)
      t = ::Vident2::Stimulus::Target.parse(:input, implied: @controller)
      v = ::Vident2::Stimulus::Value.parse(:count, 1, implied: @controller)
      plan = plan_with(
    ...
    def test_stimulus_null_value_renders_as_literal_null
      v = ::Vident2::Stimulus::Value.parse(:cfg, ::Vident2::Stimulus::Null, implied: @controller)
