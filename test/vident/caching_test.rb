...
module Vident
  class CachingTest < Minitest::Test
    ...
    def test_depends_on_multiple_classes
      dep1 = Class.new { def self.component_modified_time; "dep1"; end }
      dep2 = Class.new { def self.component_modified_time; "dep2"; end }
    ...
    def test_component_modified_time_with_dependencies
      dep1 = Class.new { def self.component_modified_time; "dep1_time"; end }
      dep2 = Class.new { def self.component_modified_time; "dep2_time"; end }
    ...
    def test_cache_keys_for_sources_compacts_nil_values
      @component.define_singleton_method(:mixed_method) do
        [
          (obj = Object.new; obj.define_singleton_method(:cache_key) { "source1" }; obj),
          nil,
          "test"
        ]
      end
    ...
    def test_generate_cache_key_handles_empty_sources
      ...
      empty_component_class = Class.new do
        include Vident::Caching
        def self.name; "EmptyComponent"; end
        def self.current_component_modified_time; "time"; end
    ...
    def test_generate_cache_key_with_blank_components
      ...
      blank_component_class = Class.new do
        include Vident::Caching
        def self.name; ""; end  # Empty name
        def self.current_component_modified_time; ""; end  # Empty time
