...
class GreetersEnhancedButtonComponentTest < ViewComponent::TestCase
  def test_stimulus_identifier_matches_v1
    assert_equal "greeters/enhanced_button_component",
      Greeters::EnhancedButtonComponent.stimulus_identifier_path
    assert_equal "greeters--enhanced-button-component",
      Greeters::EnhancedButtonComponent.stimulus_identifier
  end
  ...
  def test_renders_with_merged_attributes
    render_inline(Greeters::EnhancedButtonComponent.new(text: "Test Button", loading: true))
  ...
  def test_dsl_actions_emitted_on_root
    ...
    render_inline(Greeters::EnhancedButtonComponent.new)
