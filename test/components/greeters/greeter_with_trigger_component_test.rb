...
class GreetersGreeterWithTriggerComponentTest < ViewComponent::TestCase
  def test_stimulus_identifier_matches_v1
    assert_equal "greeters/greeter_with_trigger_component",
      Greeters::GreeterWithTriggerComponent.stimulus_identifier_path
    assert_equal "greeters--greeter-with-trigger-component",
      Greeters::GreeterWithTriggerComponent.stimulus_identifier
  end
