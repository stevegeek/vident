...
class PhlexGreetersV2GreeterButtonComponentTest < Minitest::Test
  def test_stimulus_identifier_matches_v1
    assert_equal "phlex_greeters/greeter_button_component",
      PhlexGreetersV2::GreeterButtonComponent.stimulus_identifier_path
    assert_equal "phlex-greeters--greeter-button-component",
      PhlexGreetersV2::GreeterButtonComponent.stimulus_identifier
  end

  def test_renders_button_with_default_messages
    html = PhlexGreetersV2::GreeterButtonComponent.new.call
  ...
  def test_stimulus_values_from_root_element_attributes
    html = PhlexGreetersV2::GreeterButtonComponent.new(
  ...
  def test_custom_before_message_is_rendered_as_content
    html = PhlexGreetersV2::GreeterButtonComponent.new(before_clicked_message: "Wave").call
