...
class PhlexGreetersV2InheritedGreeterComponentTest < Minitest::Test
  def test_inherits_stimulus_identifier_path_override
    assert_equal "phlex_greeters/inherited_greeter_component",
      PhlexGreetersV2::InheritedGreeterComponent.stimulus_identifier_path
  end

  def test_inherits_parent_stimulus_declarations_and_merges_status_target
    html = PhlexGreetersV2::InheritedGreeterComponent.new(cta: "X").call
