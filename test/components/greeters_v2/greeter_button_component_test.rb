...
class GreetersV2GreeterButtonComponentTest < ViewComponent::TestCase
  def test_stimulus_identifier_matches_v1
    assert_equal "greeters/greeter_button_component",
      GreetersV2::GreeterButtonComponent.stimulus_identifier_path
    assert_equal "greeters--greeter-button-component",
      GreetersV2::GreeterButtonComponent.stimulus_identifier
  end

  def test_renders_button_with_default_messages
    render_inline(GreetersV2::GreeterButtonComponent.new)
    assert_selector "button", text: "Greet"
  end

  def test_custom_before_message_is_rendered_as_content
    render_inline(GreetersV2::GreeterButtonComponent.new(before_clicked_message: "Wave"))
