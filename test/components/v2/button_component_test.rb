...
class V2ButtonComponentTest < ViewComponent::TestCase
  def test_stimulus_identifier_matches_v1
    assert_equal "button_component", V2::ButtonComponent.stimulus_identifier_path
    assert_equal "button-component", V2::ButtonComponent.stimulus_identifier
  end

  def test_renders_button_with_default_text
    render_inline(V2::ButtonComponent.new)
  ...
  def test_applies_primary_style_classes
    render_inline(V2::ButtonComponent.new(style: :primary))
    assert_selector "button.btn.btn-primary"
  end

  def test_applies_secondary_style_classes
    render_inline(V2::ButtonComponent.new(style: :secondary))
    assert_selector "button.btn.btn-secondary"
  end

  def test_includes_stimulus_data_attributes
    render_inline(V2::ButtonComponent.new(text: "Test", clicked_count: 5))
    assert_selector "button[data-controller='button-component']"
