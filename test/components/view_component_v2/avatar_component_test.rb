...
class ViewComponentV2AvatarComponentTest < Minitest::Test
  def test_stimulus_identifier_matches_v1
    assert_equal "view_component/avatar_component",
      ViewComponentV2::AvatarComponent.stimulus_identifier_path
    assert_equal "view-component--avatar-component",
      ViewComponentV2::AvatarComponent.stimulus_identifier
  end

  def test_no_stimulus_controller_flag
    refute ViewComponentV2::AvatarComponent.stimulus_controller?
  end

  def test_public_readers_default
    component = ViewComponentV2::AvatarComponent.new(initials: "JD")
  ...
  def test_public_readers_populated
    component = ViewComponentV2::AvatarComponent.new(
      initials: "AB",
  ...
  def test_shape_class
    circle = ViewComponentV2::AvatarComponent.new(initials: "JD", shape: :circle)
    assert_equal "rounded-full", circle.send(:shape_class)
    square = ViewComponentV2::AvatarComponent.new(initials: "JD", shape: :square)
    assert_equal "rounded-md", square.send(:shape_class)
  end

  def test_caching_included
    assert ViewComponentV2::AvatarComponent.included_modules.include?(::Vident2::Caching)
  end
...
class ViewComponentV2AvatarComponentRenderTest < ViewComponent::TestCase
  def test_renders_as_img_when_url_given
    render_inline(ViewComponentV2::AvatarComponent.new(
      initials: "JD",
  ...
  def test_renders_as_div_with_initials_when_no_url
    render_inline(ViewComponentV2::AvatarComponent.new(initials: "JD"))
