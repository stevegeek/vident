...
class PhlexV2AvatarComponentTest < Minitest::Test
  def test_stimulus_identifier_matches_v1
    assert_equal "phlex/avatar_component",
      PhlexV2::AvatarComponent.stimulus_identifier_path
    assert_equal "phlex--avatar-component",
      PhlexV2::AvatarComponent.stimulus_identifier
  end

  def test_no_stimulus_controller_flag
    refute PhlexV2::AvatarComponent.stimulus_controller?
  end

  def test_public_readers
    component = PhlexV2::AvatarComponent.new(initials: "JD")
  ...
  def test_all_props
    component = PhlexV2::AvatarComponent.new(
      initials: "AB",
  ...
  def test_renders_as_img_when_url_given
    html = PhlexV2::AvatarComponent.new(initials: "JD", url: "https://example.com/a.jpg").call
  ...
  def test_renders_as_div_with_initials_when_no_url
    html = PhlexV2::AvatarComponent.new(initials: "AB").call
  ...
  def test_no_data_controller_emitted
    html = PhlexV2::AvatarComponent.new(initials: "JD").call
    refute_match(/data-controller/, html)
  end

  def test_shape_class_helper
    circle = PhlexV2::AvatarComponent.new(initials: "JD", shape: :circle)
    assert_equal "rounded-full", circle.send(:shape_class)

    square = PhlexV2::AvatarComponent.new(initials: "JD", shape: :square)
