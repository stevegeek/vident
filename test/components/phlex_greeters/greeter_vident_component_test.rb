...
class PhlexGreetersGreeterVidentComponentTest < Minitest::Test
  ...
  def test_input_has_two_targets_combined_in_one_attribute
    ...
    html = PhlexGreeters::GreeterVidentComponent.new(cta: "X").call
